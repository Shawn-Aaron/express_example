 ...
 */
 ...
 router.get('/sendgoods', function(req, res, next) {
   ...
   'WHERE ddate_out >= \'' + yearBegin + '\' AND ddate_out <= \'' + yearEnd + '\' GROUP BY KH) a LEFT JOIN ' +
   '(SELECT TOP 10 KH,SUM(nMoney) AS text FROM dbo.URDailyfnout WHERE ddate_out >= \'' + beginDate + '\' AND ' +
